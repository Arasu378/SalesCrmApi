...
public class GetPersonEmailByPersonIdClass {
	private static ArrayList<PersonEmailModel>personEmailList=new ArrayList<PersonEmailModel>();
	public static PersonEmailResponse getPersonEmailByPersonId(int PersonId){
	...
	public static ArrayList<PersonEmailModel>getPersonEmailList(int PersonId){
		Connection connection =null;
		Statement st=null;
		personEmailList.clear();
		try{
