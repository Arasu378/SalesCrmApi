...
public class GetStagesByUserProfileIdClass {
	private static ArrayList<StagesModel>stagesList=new ArrayList<StagesModel>();
public static StagesResponse getStages(int UserProfileId){
	...
	try{
		String query="CALL `Settings.Stages_GetStagesByUserProfileId`("+UserProfileId+")";
